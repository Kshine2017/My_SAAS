    ...
    : QWidget(parent)
{
    ...
    m_pMinimizeButton->setIcon(QIcon(":/picture/titlebar/min.png"));
    m_pMinimizeButton->setFlat(true);

    m_pMaximizeButton->setIconSize(QSize(27,22));
    m_pMaximizeButton->setIcon(QIcon(":/picture/titlebar/max.png"));
    m_pMaximizeButton->setFlat(true);

    m_pCloseButton->setIconSize(QSize(27,22));
    m_pCloseButton->setIcon(QIcon(":/picture/titlebar/close.png"));
        ...
        else if (pButton == m_pMaximizeButton)
        {
           // pWindow->isMaximized() ? {pWindow->showNormal() : pWindow->showMaximized();
            ...
            else
            {
                ...
                m_pMaximizeButton->setIcon(QIcon(":/picture/titlebar/unmax.png"));
